...
@section('title', 'Regístrate en la plataforma')
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        @else
                            <div class="text-center text-muted mb-4">
                                <small>Ingresa tus credenciales para registrarte al sistema</small>
                            </div>
                        @endif
                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="Contrseña" type="password" name="password"
